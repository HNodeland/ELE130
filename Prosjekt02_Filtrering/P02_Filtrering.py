...
filenameCalcOnline = "P02_calcOnline_FIR_01.txt"
# --------------------------------------------------------------------
        ...
        while True:
            ...
            if len(filenameCalcOnline)>4:
                if k == 0:
                    ...
                    CalculationsToFileHeader += "0=Temp, 1=Temp_fir \n "
...
def MathCalculations(Tid, Temp, Temp_fir,m_verdi):
    ...
    # Pådragsberegning
#---------------------------------------------------------------------
#def filterIIR(Measurements, NoOfMeasurements):
    
#def filterFIR(Measurements, NoOfMeasurements):
